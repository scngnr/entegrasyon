...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <div class="container-xxl" id="kt_content_container">
    ...
    <div class="card">
      <!--begin::Card body-->
      <div class="card-body">      <!--begin::Stepper-->
            <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
              ...
              <form class="mx-auto mw-600px w-100 py-10" novalidate="novalidate" id="kt_create_account_form">
                    ...
                    <div class="fv-row mb-0">
                      ...
                      <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                          ...
                          <!--end::Label-->
                          <!--begin::Input-->
                          <select wire:model="searchValue" wire:change="pazaryeriSearch()"  data-placeholder="Bir seçim yapın..." data-dropdown-parent="#kt_modal_create_account" class="form-select form-select-solid fw-bolder">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                          ...
                          <select wire:model="magzaId" aria-label="Select a Country" data-control="select2" data-placeholder="Bir seçim yapın..." data-dropdown-parent="#kt_modal_create_account" class="form-select form-select-solid fw-bolder">
                ...
                <div data-kt-stepper-element="content">
                  <?php if($searchValue == 'woocommerce'){ ?>

                  <?php }else{ ?>
                         @livewire('product-eslestirme-component')
                  <?php } ?>
                </div>
                <!--end::Step 2-->
                <!--begin::Step 5-->
                ...
                <div class="d-flex flex-stack pt-15">
                  ...
                  <!--begin::Wrapper-->
                  <div>
                    <button wire:click="productMatches" type="submit" class="btn btn-lg btn-primary me-3" data-kt-stepper-action="submit">
