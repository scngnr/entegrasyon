<?php //                  -- Pazaryeri Fiyat Eklenen Ürünleri Bul--   ?>
...
<?php //                  -- Bulunan Ürünlerin mağza Idlerini Arraya Al--   ?>
...
@for($i = 0; $i < count($olusturulanMagzalar); $i++)
  ...
  <div>
    <?php //                  -- Ürünler Sınıfını kullanarak Pazaryerine Eklenmiş Ürünleri Bul --   ?>
    <?php $findProductMach = new \Scngnr\Product\Product;
          $findMatch = $findProductMach->pazaryeriMatchInfo->productMatchSearch($product->id, $olusturulanMagzalar[$i]);
          if($findMatch){
    ?>

    <?php //                  -- Fiyat Eklnemiş ve Pazaryerine Eklenmiş Ürünlerin Fiyatlarını Listele --   ?>
    <?php $findMagza = \Scngnr\Product\Models\pazaryeri_fiyat::where('magaza', $olusturulanMagzalar[$i])
