...
{{-- <i data-bs-toggle="tooltip" data-bs-html="true" title=""><span class="iconify" data-icon="logos:woocommerce-icon"></span></i>
<i data-bs-toggle="tooltip" data-bs-html="true" title=" "><span class="iconify" data-icon="logos:opencart"></span></i>
<i data-bs-toggle="tooltip" data-bs-html="true" title=" "><span class="iconify" data-icon="simple-icons:magento"></span></i>
<i data-bs-toggle="tooltip" data-bs-html="true" title=" "><span class="iconify" data-icon="akar-icons:instagram-fill"></span></i>
<i data-bs-toggle="tooltip" data-bs-html="true" title=" "><span class="iconify" data-icon="logos:facebook"></span></i> --}}

<?php $allPf = \Scngnr\Product\Models\pazaryeri_fiyat::where('productId', $product->id)->get(); ; ?>

@for($i = 0 ; $i < count($allPf) ; $i ++)

  <?php $currentMagza = $allPf[$i]->magaza ?>
  @if($allPf)
    <?php $findMagaza = \Scngnr\Product\Models\pazaryeri_info::where('id', $allPf[$i]->magaza)->first() ?>
    <?php $findpf = \Scngnr\Product\Models\pazaryeri_fiyat::where('magaza', $findMagaza->id)->get();  ?>

    <div>
      <i data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
        <?php
        switch ($allPf[$i]->pazaryeri) {
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="ms-5">
                                  <!--begin::Title-->
                                  <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">{{$findMagaza->magazaAdi}}</a>
                                  <!--end::Title-->
                                </div>
                              </div>
                            </td>
