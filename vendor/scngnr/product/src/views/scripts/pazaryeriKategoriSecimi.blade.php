...
<div class="modal fade overflow-auto" id="kt_modal_create_account" tabindex="-1" aria-hidden="true" style="max-height:89%;">
  <!--begin::Modal dialog-->
  <div class="modal-dialog mw-1000px">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <!--begin::Title-->
        <h2>Pazaryeri Ürün Eşleştirme</h2>
        <!--end::Title-->
        <!--begin::Close-->
                ...
                <div class="fv-row mb-0">
                  ...
                  <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                      ...
                      <!--end::Label-->
                      <!--begin::Input-->
                      <select id="PazaryeriModal" name="urunEslestirModalpazaryeri"  onchange="selects('Pazaryeri')"data-control="select2" data-placeholder="Bir seçim yapın..." data-dropdown-parent="#kt_modal_create_account" class="form-select form-select-solid fw-bolder">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                      ...
                      <select id="PazaryeriModalmagza" onchange="selectMazga('Pazaryeri')" name="urunEslestirModalmagza" aria-label="Select a Country" data-control="select2" data-placeholder="Bir seçim yapın..." data-dropdown-parent="#kt_modal_create_account" class="form-select form-select-solid fw-bolder">
                        <option value="">Bir Seçim yapın...</option>
