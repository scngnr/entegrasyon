                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="../../demo3/dist/apps/ecommerce/catalog/edit-category.html" class="symbol symbol-50px">
                      ...
                      <span class="symbol-label" style="background-image:url({{$thumbnail->pictures}});"></span>
                    </a>
                    <!--end::Thumbnail-->
                    <div class="ms-5">
                      <!--begin::Title-->
                      <a href="{{$thumbnail->pictrures}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$category->categoryAdi}}</a>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="text-muted fs-7 fw-bolder">{{$thumbnail->name}}</div>
                      <!--end::Description-->
                    </div>
                  </div>
                </td>
