  ...
  public function edit($id, $array){
    ...
    */
    ...
    public function transactions($id, $array){
      ...
      $this->getResponse($access_token, 'POST', $this->baseEndPoint. '/'. $id. '/' . 'transactions', $array);
    }
    ...
    */
    ...
    public function debitTransactions($id){
      ...
      $this->getResponse($access_token, 'DELETE', $this->baseEndPoint. '/'. $id. '/' . 'debit_transactions');
    }
    ...
    */
    ...
    public function creditTransactions($id){

      $this->getResponse($access_token, 'PATCH', $this->baseEndPoint. '/'. $id. '/' . 'credit_transactions');
    }
}
