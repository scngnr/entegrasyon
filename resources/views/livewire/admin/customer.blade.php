          ...
          <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table" >
            ...
            <thead>
              ...
              <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                ...
                <th class="min-w-125px">Toplam Siparişi</th>
            ...
            <tbody class="fw-bold text-gray-600">
              @foreach($allCustomer as $customer)
                <tr>
                  ...
                  <!--begin::Name=-->
                  <td>
                    <a  class="text-gray-800 text-hover-primary mb-1">@if($customer->customerName == '') Pazaryerinden isim alınamadı @else {{$customer->customerName}} @endif</a>
                  </td>
                  <!--end::Name=-->
                  <!--begin::Email=-->
                  <td>
                  ...
                  <!--end::Email=-->
                  <!--begin::Company=-->
                   <?php $customerAllOrder =  \App\Models\Order::where('customerName', $customer->customerName)->get() ?>
                  <td> {{count($customerAllOrder)}}</td>
                  <!--end::Company=-->
                  <!--begin::Action=-->
                  <td class="text-end">
