<div>
  ...
  <main id="main-container">
      ...
      <div class="content">
          ...
          <!-- Overview -->
          <h2 class="h4 font-w300 mt-50">Genel Bakış</h2>
                  ...
                  <div class="row items-push">
                      ...
                      <div class="col-lg-7 offset-lg-1">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-lg" id="hosting-settings-profile-name" name="hosting-settings-profile-name" placeholder="Enter your name.." value="{{Auth::user()->name}}">
                          </div>
                          <div class="form-group">
                              <label for="hosting-settings-profile-email">Email Address</label>
                              <input type="email" class="form-control form-control-lg" id="hosting-settings-profile-email" name="hosting-settings-profile-email" placeholder="Enter your email.." value="{{Auth::user()->email}}">
                          </div>
                          <div class="form-group">
          ...
          <div class="block">
              <div class="block-header block-header-default">
                  <h3 class="block-title">
                      <i class="fa fa-building fa-fw mr-5 text-muted"></i> Fatura Adresi
                  </h3>
              </div>
              <div class="block-content">
                  <div class="row items-push">
